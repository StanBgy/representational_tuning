...
The script reads `angle_roi_best_roi.csv` (or oself for within ROI) from the working directory. This file is generated by the `new_angle.ipynb` notebook.
...
> the script to point to the correct location of the csv files.
